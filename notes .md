...
<div class="left-[40rem] fixed inset-y-0 right-0 z-0 hidden lg:block xl:left-[50rem] font-inter">
  <svg
...
<div class="px-4 py-10 sm:px-6 sm:py-28 lg:px-8 xl:px-28 xl:py-32">
  <div class="mx-auto max-w-xl lg:mx-0">
    ...
    <p class="text-[2rem] mt-4 font-semibold leading-10 tracking-tighter text-brand text-balance">
    ...
    <div class="flex">
      <div class="w-full sm:w-auto bg-[#FCF7F8]">
